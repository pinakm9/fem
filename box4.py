...
bcs = [dol.DirichletBC(FS, dol.Expression(('0','0', '1'), degree = 2), boundaries, 2),
       dol.DirichletBC(FS, dol.Expression(('-10*x[0]+5','5', '0'), degree = 2), boundaries, 4),
       dol.DirichletBC(FS, dol.Expression(("5*(1-x[1])", "5*(1-x[1])","x[1]"), degree = 2), boundaries, 1),
       dol.DirichletBC(FS, dol.Expression(("-5*(1-x[1])", "5*(1-x[1])","x[1]"), degree = 2), boundaries, 3)]
...
# Initial conditions
U_n = dol.interpolate(dol.Expression(("(-10*x[0]+5)*(1-x[1])", "5*(1-x[1])","x[1]"), degree = 2), FS)
